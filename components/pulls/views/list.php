<form name="list" action="<?=current_url(true);?>" method="post" >
	...
	<div class="actions" >
            ...
            <a href="<?=site_url('pulls/add');?>"  class="styled add"    ><?=lang('label_add');?></a>
            <a href="<?=site_url('pulls/edit');?>" class="styled edit"   ><?=lang('label_edit');?></a>
            <a href="<?=site_url('pulls');?>"      class="styled delete" ><?=lang('label_delete');?></a>
        ...
        <table class="list" cellpadding="0" cellspacing="2" >
            ...
            <tr class="row <?=$row_class;?>" >
                ...
                <td style="text-align: left;" >
                    <a href="<?=site_url('pulls/edit/'.$pull['pull_id']);?>" >
                        <?=$pull['title'];?>
                    </a>
                    <?php if(!empty($pull['description_'.Language::getDefault()])){ ?>
