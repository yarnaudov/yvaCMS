...
var pathToImages = APANEL_HOME_DIR+'/modules/jscalendar/images/';	// Relative to your HTML file
...
var selectBoxRolloverBgColor = '#EEEEEE'; // Background color on drop down lists(rollover)
...
{
	calendarDiv.style.left = getleftPos(inputObj)-180 + 'px';
