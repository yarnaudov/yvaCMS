...
<form name="list" action="<?=current_url(true);?>" method="post" >
	...
	<div id="filter_content" >
		...
		<input type="checkbox" name="filters[type][]" value="1" <?=(!isset($filters['type']) || in_array(1, $filters['type'])) ? 'checked' : '';?> >
		<label><?=lang('label_impressions');?></label>
				
		<input type="checkbox" name="filters[type][]" value="2" <?=(!isset($filters['type']) || in_array(2, $filters['type'])) ? 'checked' : '';?> >
