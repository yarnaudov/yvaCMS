...
<form name="add" action="<?php echo current_url();?>" method="post" >
	...
	<div class="actions" >
	    ...
	    <a href="<?php echo site_url('modules/');?>" class="styled cancel" ><?php echo lang('label_cancel');?></a>
	...
	<table class="add" cellpadding="0" cellspacing="0" >
	        ...
	        <td class="left" >
	            ...
	            <!-- mandatory information  -->
                            ...
                            <table class="box_table" cellpadding="0" cellspacing="0" >
                                ...
                                <tr>	      			
                                    ...
                                    <td style="padding: 2px 0 0 1px;" >
                                        ...
                                        <a href  = "<?php echo site_url('modules/types');?>" 
                    ...
                    <div class="box" >
	      	      <span class="header" ><?php echo lang('label_display_module_in');?></span>
