<div class="box" >
    <span class="header" ><?php echo lang('label_advanced_display_rules');?></span>
            ...
            <tr>
                <td>
                    ...
                    <div style="overflow: auto;" >
                        ...
                        <button class="styled styled_small add" name="add_rule" type="button" ><?php echo lang('label_add');?></button>
                    </div>
                    ...
                    <ol class="rules" >
                      ...
                      <li>
                        <span><?php echo $display_rule;?></span>
                        <input type="hidden" name="params[display_rules][]" value="<?php echo $display_rule;?>" >
...
<script type="text/javascript" >
    ...
    $('button[name=add_rule]').click(function(){
        ...
        var html = '<li>'
                   ...
                   +'<img class="handle" src="'+DOCUMENT_BASE_URL+'<?php echo APANEL_DIR;?>/img/iconMove.png" >'
                   +'<a class="styled delete" title="<?php echo lang('label_delete');?>">&nbsp;<\/a>'
                   +'<\/li>';
