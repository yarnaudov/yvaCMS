...
<form name="list" action="<?php echo current_url(true);?>" method="post" >
    ...
    <div id="page_header" >
        ...
        <div class="text" >
            ...
            <span>&nbsp;»&nbsp;</span>
            <!--
            <img src="<?php echo base_url('img/iconCategories_25.png');?>" >
            -->
	...
	<div class="actions" >
            ...
            <a href="<?php echo site_url('categories/add/'.$this->extension);?>"  class="styled add"    ><?php echo lang('label_add');?></a>
            <a href="<?php echo site_url('categories/edit/'.$this->extension);?>" class="styled edit"   ><?php echo lang('label_edit');?></a>
            <a href="<?php echo site_url('categories');?>"                        class="styled delete" ><?php echo lang('label_delete');?></a>
            <a href="<?php echo site_url($this->extension);?>"                    class="styled cancel" ><?php echo lang('label_cancel');?></a>
	...
	<table class="list" cellpadding="0" cellspacing="2" >
            ...
            <tr class="row <?php echo $row_class;?>" >
                ...
                <td>
                    <input type="checkbox" class="checkbox" name="categories[]" value="<?php echo $category['id'];?>" />
                </td>
                <td style="text-align: left;" >
                    <a href="<?php echo site_url('categories/edit/'.$category['id'].'/'.$this->extension);?>" >
                        <?php echo $category['title'];?>
                    </a>
                    <?php if(!empty($category['description'])){ ?>
                    <div class="description" >(<span class="head" ><?php echo lang('label_description');?>:</span> <span class="content" ><?php echo strip_tags($category['description']);?></span>)</div>
                    <?php } ?>
                </td>
                <td>
                ...
                <td><?php echo User::getDetails($category['created_by'], 'user');?></td>
