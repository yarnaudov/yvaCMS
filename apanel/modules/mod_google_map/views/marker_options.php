...
<div id="marker_info" title="<?=lang('label_mod_google_map_marker_info');?>" style="display:none;" >
...
<img src="<?=base_url('img/iconAdministration.png');?>" style="display:none;" onload="marker_info_dialog();marker_description_editor();" >